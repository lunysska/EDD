...
![libros Desordenados](images/punto.png {width=300})<br>
...
![libros Desordenados](images/mapa.png)<br>
...
## 1.2 La abstracción
![libros Desordenados](images/abstraccion.png)<br>

## 1.3 Proceso de la abstracción hasta el TDA
![libros Desordenados](images/transformacion.png)<br>

## 1.4 TDA
![libros Desordenados](images/tda.png)<br>

## 1.5 Tipos de especificación en los TDAs
![libros Desordenados](images/lenguajes.png)<br>

## 1.6 Ejemplos de TDAs
Ejemplo con un lenguaje informal:<br>
![libros Desordenados](images/matriz.png)<br>
Ejemplo con un lenguaje formal:<br>
![libros Desordenados](images/booleano.png)<br>
